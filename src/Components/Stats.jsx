...
const Stats = () => {
  return (
    <div className='flex flex-col xs:flex-row flex-wrap justify-center items-center my-5 mx-3 '>
      {
        stats.map((stat , index)=>(
          <div key={index} className=" flex-1 flex   text-center  justify-center items-center">
